<template>
  <div class="col-xl-8 col-md-12">
    <!-- Post -->
    <div class="row mt-5 mb-7 pb-5 mx-5">
      <!-- Card -->
      <div class="card card-body mb-100">
        <h2 class="font-weight-bold mt-50">
    ...
    >
     ...
     <!-- <slide
      ...
      >  -->
       <div class="speaker-card"> 
        <div class="right">
          <img class="carousel-img" src="@/assets/Kleber Melo e Silva.jpg" width="1350 px" height="auto"/>
        </div>
      ...
      <div class="speaker-card"> 
        <div class="right">
          <img class="carousel-img" src="@/assets/Vinod_KU.jpg" width="1350 px" height="auto" />
        </div>
      ...
      <div class="speaker-card"> 
        <div class="right">
          <img class="carousel-img" src="@/assets/Biplab.jpg" width="1350 px" height="auto"/>
        </div>
      ...
      > -->
       <div class="speaker-card"> 
        <div class="right">
          <img class="carousel-img" src="@/assets/Dr Sze Sing Lee.jpg" width="1350 px" height="auto"/>
        </div>
      ...
      <div class="speaker-card"> 
        <div class="right">
          <img class="carousel-img" src="@/assets/Dr. Nilesh Jayantilal Vasa.jpg" width="1350 px" height="auto"/>
        </div>
      ...
      <!-- </slide>  -->
       ...
       <!-- <slide
        ...
        :centerMode="true"
      >
        <img class="carousel-img" src="@/assets/speaker2.jpeg" />
      </slide>
      <slide
        data-index="2"
        data-name="MySlideName"
